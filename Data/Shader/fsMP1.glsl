...
void main(){
    ...
    vec3 color = texture2D(tC,texCoords).rgb;
    ...
    vec3 diffuse = diff * color * lightCol;
    ...
    shadow = 1.0 - shadow;
    colorout = (color * diffuse) * vec3(shadow,shadow,shadow);// + (specular);
