...
namespace FusionEngine.Resonance.Forms
{
    ...
    public class RequestFileForm : WindowForm
    {
        ...
        public Texture2D FolderPic = new Texture2D("data/UI/folder1.png", LoadMethod.Single, true);
        public Texture2D FilePic = new Texture2D("data/UI/file1.png", LoadMethod.Single, true);
