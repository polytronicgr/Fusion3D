...
namespace Vivid3D.Pick
{
  ...
  int screenHeight )
        ...
        public static Ray MouseRay (
          ...
          Vector2 mouse )
        {
            // these mouse.Z values are NOT scientific. Near plane needs to be < -1.5f or we have
            // trouble selecting objects right in front of the camera. (why?)
